...
activities = {
    ...
    "Basketball Team": {
        "description": "Join the school basketball team and compete in league tournaments",
    ...
    "Music Ensemble": {
        "description": "Play in the school orchestra and perform at concerts",
        "schedule": "Mondays and Thursdays, 3:30 PM - 4:30 PM",
        "max_participants": 25,
        "participants": ["noah@mergington.edu", "claire@mergington.edu"]
    },
    "Debate Team": {
    ...
    "Science Club": {
        "description": "Conduct experiments and explore scientific topics through hands-on projects",
